...
import { ITEMS_GAP, PokemonItem } from '@/modules/pokemons/PokemonItem';
...
const FlatListAnimation: FC = () => {
  const [listAPokemons, setListAPokemons] = useState(getRandomPokemons(8));
  const [listBPokemons, setListBPokemons] = useState(getRandomPokemons(8));
